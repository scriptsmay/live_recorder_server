...
DANMAKU_ARCHIVE_DIR="${DANMAKU_ARCHIVE_DIR:-$APP_DATA_DIR/danmaku_archive}"
BILIUP_WORK_DIR="${BILIUP_WORK_DIR:-$APP_DATA_DIR/biliup}"

mkdir -p "$VIDEO_DOWNLOAD_DIR" "$BILIUP_WORK_DIR" "$DANMAKU_OUTPUT_DIR" "$DANMAKU_ARCHIVE_DIR" /app/logs
