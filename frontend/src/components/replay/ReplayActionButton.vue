...
<template>
  <div class="inline-flex justify-end gap-1.5">
    <button
      class="inline-flex items-center gap-0.5 px-2.5 py-1 text-xs rounded-md border border-gray-200 text-gray-600 bg-white hover:bg-gray-100 active:bg-gray-200 transition-colors disabled:opacity-50"
      @click="gotoLog"
    >
      <span>日志</span>
      <svg
