      ...
      <div class="flex items-center flex-wrap gap-2 mt-3">
        ...
        >
          <span class="flex items-center">
            ...
            <span>{{ segmentsExpanded ? '收起分段' : '展开分段' }}</span>
          </span>
        </button>
        ...
        <template v-if="isDone">
          ...
          <span class="text-gray-400">|</span>
          <button
            class="px-2.5 py-1 text-xs font-medium rounded-md border border-green-600 text-green-700 hover:bg-green-50 transition-colors"
