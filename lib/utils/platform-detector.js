...
const SUPPORTED_PLATFORMS = [
  ...
  { domain: 'twitch.tv', platformId: 'twitch' },
  { domain: 'douyin.com', platformId: 'douyin' },
  { domain: 'twitcasting.tv', platformId: 'twitcasting' },
];
 ...
 * @returns {string|null} Platform ID ('douyu' | 'huya' | 'bilibili' | 'twitch' | 'douyin' | 'twitcasting'),
