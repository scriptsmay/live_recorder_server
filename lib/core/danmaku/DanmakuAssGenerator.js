...
Style: Scroll,${style.fontName},${fontSize},&H${alphaHex}FFFFFF,&H00FFFFFF,${outlineAss},&H00000000,-1,0,0,0,100,100,0,0,1,${style.outline},${style.shadow},2,10,10,5,1
...
`;
  ...
  _rgbToAssColour(rgbHex) {
    const hex = String(rgbHex || '000000').replace(/^#/, '').padStart(6, '0').slice(0, 6);
